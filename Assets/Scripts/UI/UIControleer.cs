namespace Blast.Core
{
    ...
    public class UIControleer : MonoBehaviour
    {
        ...
        public void SetDependencies(GameProcessController gameProcessController)
        {
            ...
            _outOfSpacePanel.SetDependencies(gameProcessController);
            _resultsPanel.SetDependencies(gameProcessController);
        }
        ...
        {
            _textCountCoins.text = _gameProcessController.GetCountCoins().ToString();
        }

        public void UpdateCountCoinsFromAnim()
        {
            AudioController.Instance.PlayAudio(AudioController.AudioType.CoinCollect);
            _gameProcessController.AddCountCoins(COUNT_COINS_FROM_ANIM);
            UpdateTextCountCoins();
        }
        ...
        {
            _gameProcessController.RestartApplication();
        }
